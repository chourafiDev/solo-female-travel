...
import { generateSearchMetadata, generateSearchPageSchema, siteConfig } from '@/lib/metadata';
        ...
        <header className="mb-8">
          <h1 className="title mb-1">
            {query
              ...
              : category
                ? `Searching in ${siteConfig.categories[category as keyof typeof siteConfig.categories]?.title || category}`
