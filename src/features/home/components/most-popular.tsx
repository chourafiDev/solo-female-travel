			...
			>
				...
				<div className="w-full">
					<div className="flex items-center justify-between mb-4">
						<h3 className="text-foreground font-semibold text-sm italic">
							Destinations
						</h3>
						<Link
							href="/destinations"
					...
					<article itemScope itemType="https://schema.org/BlogPosting">
						...
						<h4 itemProp="headline" className="post-title">
							<Link
								href="/blog/best-places-travel-solo-female-travelers"
								itemProp="url"
							>
					...
					<article itemScope itemType="https://schema.org/BlogPosting">
						...
						<h4 itemProp="headline" className="post-title">
							<Link
								href="/blog/safest-countries-solo-female-travelers"
								itemProp="url"
							>
								Best places to travel for solo female travelers
							</Link>
