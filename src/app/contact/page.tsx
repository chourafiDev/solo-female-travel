					...
					<div className="flex-1 lg:border-r lg:pr-10">
						<div className="space-y-2 mb-10">
							...
							<p className="text-muted-foreground text-base">
								...
								destination advice, or want to share your travel story,
						...
						<div className="space-y-8">
							...
							<div>
								...
								<p className="text-muted-foreground text-[15px] mb-3">
									Follow us for daily travel inspiration, safety tips, and
							...
							<div>
								...
								<p className="text-muted-foreground text-[15px]">
									...
									during business days. For urgent travel safety concerns,
