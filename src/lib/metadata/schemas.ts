...
export function generateBlogPostingSchema(
	...
	const keywords = post.category?.title
		? `solo female travel, ${post.category.title.toLowerCase()}, travel guide, budget travel`
		: "solo female travel, travel guide, budget travel";
	...
	return {
		...
		image: {
			"@type": "ImageObject",
			url: post.mainImage?.asset?.url || `${siteConfig.url}/default-image.jpg`,
