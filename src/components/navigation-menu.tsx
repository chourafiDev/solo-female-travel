...
function NavigationMenuLink({
	...
	return (
		<NavigationMenuPrimitive.Link
			...
			className={cn(
				"data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-soft-linen data-[active=true]:bg-soft-linen/50 data-[active=true]:text-foreground hover:bg-soft-linen hover:text-foreground focus:bg-soft-linen focus:text-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col justify-center gap-1 rounded-sm px-4 py-1 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			{...props}
		/>
...
function NavItemMobile({
	...
	return (
		<a
			...
			{...props}
		>
			<div className={cn("flex h-6 flex-col justify-center")}>
